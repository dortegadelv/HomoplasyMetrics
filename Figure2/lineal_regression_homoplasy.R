...
plot (data$P,data$diference,col=as.character(data$color) ,xlab="",ylab="Tau skew",main="A)",cex.lab = 3, cex.main = 3.0,cex.axis = 2,xlim=c(0,0.65),yaxt="n",pch=19, cex=2)
...
par(mar=c(5,6,4,2) + 0.1)
plot (data$MSH,data$diference,col=as.character(data$color),xlab = "",ylab="Tau skew",main="B)",cex.lab = 3, cex.main = 3.0,cex.axis = 2,xlim=c(0,0.65),yaxt="n",pch=19, cex=2)
...
plot (data$DH,data$diference,col=as.character(data$color),xlab="",ylab="Tau skew",main="C)",cex.lab = 3, cex.main = 3.0,cex.axis = 2,xlim=c(0,0.65),yaxt="n",pch=19, cex=2)
