...
setwd("/Users/vicentediegoortegadelvecchyo/Dropbox/Documents/Pinero/Articulo_homoplasia/Articulo/VersionesDeArticulo/HomoplasyPaperFigures/Figures/SupplementaryFigure4")
require(car)
library(viridis)
...
pdf("SuppFig2Legend.pdf",height=14,width=14)
par(mfrow = c(2,2))

par(mar=c(5,6,4,2) + 0.1)
plot (data$P,data$diference,col=as.character(data$color) ,xlab="",ylab="TS",main="A)",cex.lab = 3, cex.main = 3.0,cex.axis = 2,xlim=c(0,0.65),yaxt="n",pch=19)
...
par(mar=c(5,6,4,2) + 0.1)
plot (data$MSH,data$diference,col=as.character(data$color),xlab = "",ylab="TS",main="B)",cex.lab = 3, cex.main = 3.0,cex.axis = 2,xlim=c(0,0.65),yaxt="n",pch=19)
...
plot (data$DH,data$diference,col=as.character(data$color),xlab="",ylab="TS",main="C)",cex.lab = 3, cex.main = 3.0,cex.axis = 2,xlim=c(0,0.65),yaxt="n",pch=19)
...
data <- read.table("homoplasy_tau.txt",header=T)
pdf("SuppFig2_AllData.pdf",height=14,width=14)
